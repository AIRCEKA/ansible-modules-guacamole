...
def main():
    ...
    module_args = dict(
        ...
        rdp_enable_font_smoothing=dict(type='bool', default=False),
        rdp_enable_wallpaper=dict(type='bool', default=False),
        rdp_disable_audio=dict(type='bool', default=False),
        rdp_client_name=dict(type='str'),
